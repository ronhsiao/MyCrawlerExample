...
public class FBElasticImport {
    ...
    static String elasticHost = "192.168.152.160" ;
    static String elasticPort = "9200" ;
    static String elasticIndex = "fb-hb";
    static String elasticIndexType = "data";
    static String pageName = "hypebeastzh";
        ...
        for (long datatime = start ; datatime > start-86400*days ;datatime-=3600*8) {
            String uri =
                    "https://graph.facebook.com/v2.6"
                            ...
                            + "&access_token=763320637160320%7C97972b70ac829a1984519595e1763085";
                            //+ "&access_token=EAACEdEose0cBAEuS5Txhwuv45y55s0WgzTZAFFodsRvtDPaTWYZAQXqyYuV8m0d7HrLKRd83IoucOPOC9RylLx8TQNik59O5PK1RkG0ncA58PtCCVFCZCUE2T14QguLY8sEXdvJwTtQKU43kC8wsO4cs7QY1uZBMkrVVJUs2v6UbKAvuNbAh";
